...
input3entry1 = Checkbutton(window, text=checkbox1, variable = cb_val1, onvalue =1, offvalue =0).grid(row=4, column =1, sticky =W)

cb_val2 = IntVar()
cb_val2.set(0)
input3entry2 = Checkbutton(window, text=checkbox2, variable = cb_val2, onvalue =1, offvalue =0).grid(row=5, column =1, sticky =W)
